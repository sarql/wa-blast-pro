            ...
            <div className="glass-card" style={{ padding: '32px' }}>
              ...
              <div className="glass-card" style={{ padding: '24px', background: 'rgba(0,0,0,0.2)', marginBottom: '24px' }}>
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      onChange={(e) => {
                        ...
                        setCampaign({ 
                          ...campaign, 
                          delay: val.startsWith('random') ? val : parseInt(val, 10) 
                        });
                      }}
                    >
                      <option value="15">15s (Moderate Risk)</option>
                      <option value="30">30s (Safe)</option>
                      <option value="60">60s (Very Safe)</option>
                      <option value="120">120s (Extremely Safe)</option>
                      <option value="random_15_30">Random (15s-30s)</option>
                      <option value="random_30_60">Random (30s-60s)</option>
                    </select>
                  </div>
                  <div>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '8px', height: '20px', marginBottom: '12px', fontSize: '13px', color: 'var(--primary)', fontWeight: '600' }}>
                ...
                <div style={{ 
                  ...
                  <strong style={{ color: '#ef5350', display: 'block', marginBottom: '4px' }}>⚠️ Anti-Ban Guidelines:</strong>
                  <ul style={{ paddingLeft: '16px', margin: 0, display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    <li>Use a <strong>Random delay</strong> to mimic human messaging patterns.</li>
                    <li>Avoid sending duplicate text; use variables like <strong>+name</strong> to make each text unique.</li>
                    <li>For fresh/un-warmed numbers, start with 15-30 messages per day.</li>
                  </ul>
                </div>
              </div>
